          ...
          <div className="mt-6 space-y-1">
            ...
            <label className="flex flex-col text-sm font-medium text-[#7a1245]">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="আপনার পূর্ণ নাম লিখুন"
                className="mt-1 rounded-lg border border-[#c43d74]/40 px-3 py-2 bg-white/80"
                required
              />
            </label>
              ...
              <div className="flex-1">
                <label className="flex flex-col text-sm font-medium text-[#7a1245]">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="মোবাইল নম্বর"
                    className="w-full p-2 rounded border border-[#c43d74]/40 bg-white"
                    pattern="01[3-9][0-9]{8}"
                    required
                  />
                </label>
                  ...
                  <>
                    <div className="flex items-end gap-4 mb-2">
                      <input
                        ...
                        onChange={(e) => setOtp(e.target.value)}
                        placeholder="OTP লিখুন"
                        className="flex-1 p-2 rounded border border-[#c43d74]/40 bg-white"
                      />
            ...
            <label className="flex flex-col text-sm font-medium text-[#7a1245]">
              ...
              <textarea
                ...
                value={formData.voter_id}
                onChange={handleChange}
                className="mt-1 rounded-lg border border-[#c43d74]/40 px-3 py-2 bg-white/80 resize-none"
                required
              />
            </label>
