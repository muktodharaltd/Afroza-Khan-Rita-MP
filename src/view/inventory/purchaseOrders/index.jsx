    ...
    <div className=" p-10 bg-white ">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-12">
          ...
          <div className="flex flex-wrap md:flex-nowrap gap-8">
            ...
            <div className="flex-1 space-y-5 text-right">
              <div className="flex items-center">
                ...
                <Input type="text" {...register('purchaseOwner')} />
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <Input type="text" {...register('requisitionNo')} />
              </div>
              <div className="flex items-center">
                <label className="w-40 text-sm text-gray-600">
                  Contact Name :
              ...
              <div className="flex items-center">
                <label className="w-40 text-sm text-gray-600">Due Date :</label>
              ...
              <div className="flex items-center">
                ...
                <Select
                  ...
                  options={[
                    ...
                    { value: 'Cancelled', label: 'Calcelled' },
            ...
            <div className="flex-1 space-y-5 text-right">
              <div className="flex items-center">
                ...
                <Input type="text" {...register('poNumber')} />
              </div>
              <div className="flex items-center">
                <label className="w-40 text-sm text-gray-600">
                  Vendor Name :
                </label>
                <Input type="date" {...register('vendorName')} />
              </div>
              <div className="flex items-center">
                <label className="w-40 text-sm text-gray-600">
                  Tracking Number :
                </label>
                <Input type="text" {...register('trackingNo')} />
              </div>
              <div className="flex items-center">
                <label className="w-40 text-sm text-gray-600">
                  Purchase Order Date :
                </label>
                <Input type="text" {...register('poDate')} />
              </div>
              <div className="flex items-center">
                <label className="w-40 text-sm text-gray-600">
                  Excise Duty :
        ...
        <div className="text-center mt-10">
          <Button text=" Save Purchase" type="submit" />
        </div>
      </form>
    </div>
  )
