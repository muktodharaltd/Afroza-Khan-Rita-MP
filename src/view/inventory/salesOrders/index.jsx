    ...
    <div className=" p-10 bg-white ">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-12">
          ...
          <div className="flex flex-wrap md:flex-nowrap gap-8">
            ...
            <div className="flex-1 space-y-5 text-right">
              <div className="flex items-center">
                <label className="w-42 text-sm text-gray-600">
                  Sales Order Owner :
                </label>
                <Input type="text" {...register('salesOwner')} />
              </div>
              <div className="flex items-center">
                <label className="w-42 text-sm text-gray-600">Subject :</label>
              ...
              <div className="flex items-center">
                ...
                <Input type="text" {...register('customerNo')} />
              </div>
              <div className="flex items-center">
                <label className="w-42 text-sm text-gray-600">
                  Quote Name :
              ...
              <div className="flex items-center">
                <label className="w-42 text-sm text-gray-600">Pending :</label>
                <Input type="text" {...register('pending')} />
              </div>

              <div className="flex items-center">
                <label className="w-42 text-sm text-gray-600">Carrier :</label>
                <Select
                  {...register('quoteStage')}
                  options={[
              ...
              <div className="flex items-center">
                ...
                <Input type="text" {...register('salesCommission')} />
              </div>
              <div className="flex items-center">
                <label className="w-42 text-sm text-gray-600">
                  Account Name :
            ...
            <div className="flex-1 space-y-5 text-right">
              ...
              <div className="flex items-center">
                <label className="w-42 text-sm text-gray-600">Due Date :</label>
              ...
              <div className="flex items-center">
                ...
                <Input type="text" {...register('exciseDuty')} />
              </div>
              <div className="flex items-center">
                <label className="w-42 text-sm text-gray-600">Status :</label>
                <Select
                  {...register('carrier')}
                  options={[
          ...
          <table className="w-full border-collapse border table-fixed">
            <thead className="bg-gray-100">
              <tr className="text-gray-700">
                ...
                <th className="border p-1 w-36">Product Name</th>
        ...
        <section className="flex justify-end mt-10">
          <div className="space-y-4 w-[42%] bg-gray-50 p-6 rounded-lg shadow">
            {[
        ...
        <div>
          ...
          <div className="flex mb-6">
            <label className="w-42 text-sm text-gray-600 mt-1">
              Terms & Conditions :
            </label>
            <textarea
              {...register('terms')}
        ...
        <div className="text-center mt-10">
          <Button text=" Save Sales Order" type="submit" />
        </div>
      </form>
    </div>
  )
